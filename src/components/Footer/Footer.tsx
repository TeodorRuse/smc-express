    ...
    <footer className="footer">
      ...
      <div className="container footer__grid">
        ...
        <div>
          ...
          <ul>
            <li><span className="footer__legal-link">{t.footer.privacyPolicy}</span></li>
            <li><span className="footer__legal-link">{t.footer.termsConditions}</span></li>
            <li><span className="footer__legal-link">{t.footer.cookiePolicy}</span></li>
            <li><span className="footer__legal-link">{t.footer.gdpr}</span></li>
          </ul>
        </div>
      </div>
      ...
      <div className="footer__bottom">
        <span>{t.footer.legal.replace('2026', String(new Date().getFullYear()))}</span>
